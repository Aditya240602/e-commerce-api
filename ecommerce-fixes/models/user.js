...
let schema = new mongoose.Schema({
    ...
    // NEW: needed for the requireAdmin middleware to work at all.
    // Set this to true manually in the DB (e.g. via MongoDB Atlas / Compass)
    // for whichever user account you want to use as the admin.
    isAdmin: {
        type: Boolean,
        required: true,
        default: false
